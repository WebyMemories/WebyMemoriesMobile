...
const ViewArthur = ({ navigation }) => {
  ...
  return (
    <LinearGradient
      colors={['white', 'rgb(21, 39, 200)', 'rgb(17, 12, 48)', 'rgb(18, 18, 18)']}
    ...
    >
      <ScrollView contentContainerStyle={styles.scrollContainer} style={{ flex: 1 }}>
        <View style={styles.container}>
          ...
          <Image source={require('../../../assets/arthur.png')} style={styles.image} />
        ...
        >
          <View style={styles.modalContainer}>
            <View style={styles.modalContent}>
              ...
              <TouchableHighlight
                style={{ ...styles.openButton, backgroundColor: "rgb(21, 39, 200)" }}
                onPress={() => {
                  setModalVisible1(!modalVisible1);
                }}
              >
...
const styles = StyleSheet.create({
  ...
  modalContent: {
    backgroundColor: "rgb(21, 39, 200,0.5)", // Código de cor azul com 80% de opacidade
    borderRadius: 10,
    width: '80%',
    height: '65%',
    padding: 10,
